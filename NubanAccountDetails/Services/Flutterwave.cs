namespace NubanAccountDetails.Services
{
    public class Flutterwave: IFlutterwave
    {
        ...
        {
            var apiUrl = $"https://api.flutterwave.com/v3/accounts/resolve";
            ...
            var result = await _getDetails.ResolveAccountNumber(_apiKey, apiUrl,accountNumber, BanksAndCodes.banksAndCodes);
            return result;
        }
    }
}
